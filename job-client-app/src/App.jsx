...
import CompanyDetailsPage from "../components/companyDetailsPage/CompanyDetailsPage"; // Import CompanyDetailsPage
import ApplyPage from "../components/applyPage/ApplyPage"; // Import ApplyPage
import AddCompanyReviewPage from "../components/addCompanyReviewPage/AddCompanyReviewPage"; // Import AddCompanyReviewPage
import "./App.css";
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/review/:companyId" element={<AddCompanyReviewPage />} /> {/* Added route for Company Review Page */}
      </Routes>
    </Router>
  );
}
